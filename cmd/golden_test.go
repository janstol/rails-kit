...
func TestGolden(t *testing.T) {
	...
	cases := []goldenCase{
		...
		{name: "datagrids_list", cmd: datagridsCmd},
		...
		{name: "decorators_list", cmd: decoratorsCmd},
		{name: "decorators_list_json", cmd: decoratorsCmd, json: true},
		{name: "decorators_user", cmd: decoratorsCmd, args: []string{"user"}},
		{name: "decorators_user_json", cmd: decoratorsCmd, args: []string{"user"}, json: true},

		{name: "formers_list", cmd: formersCmd},
		{name: "formers_list_json", cmd: formersCmd, json: true},
		{name: "formers_user", cmd: formersCmd, args: []string{"user"}},
		{name: "formers_user_json", cmd: formersCmd, args: []string{"user"}, json: true},

		{name: "presenters_list", cmd: presentersCmd},
		{name: "presenters_list_json", cmd: presentersCmd, json: true},
		{name: "presenters_user", cmd: presentersCmd, args: []string{"user"}},
		{name: "presenters_user_json", cmd: presentersCmd, args: []string{"user"}, json: true},

		{name: "validators_list", cmd: validatorsCmd},
		{name: "validators_list_json", cmd: validatorsCmd, json: true},
		{name: "validators_email_format", cmd: validatorsCmd, args: []string{"email_format"}},
		{name: "validators_email_format_json", cmd: validatorsCmd, args: []string{"email_format"}, json: true},
	}
