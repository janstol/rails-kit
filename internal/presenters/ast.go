...
// rendered as a signature -- a presenter's parameters are part of its useful
// summary, same reasoning as helpers, decorators, and formers.
func (w *presenterWalker) handleDef(def *parser.DefNode, visibility string, singleton bool) {
	if singleton {
