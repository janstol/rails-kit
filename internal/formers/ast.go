...
// rendered as a signature -- a former's parameters are part of its useful
// summary, same reasoning as helpers and decorators, even though most former
// methods take none.
func (w *formerWalker) handleDef(def *parser.DefNode, visibility string, singleton bool) {
	if singleton {
